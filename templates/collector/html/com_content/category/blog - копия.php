...
?>
<div class="rooms-page row <?=$this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Hotel">
	...
	<?php if (!empty($this->intro_items)) : ?>
		<?php foreach ($this->intro_items as $key => &$item) : ?>
			...
			<?php //if ($rowcount === 1) : ?>
				...
				<!-- <div class="row items cols-<?php // echo (int) $this->columns; ?> <?php //echo 'row-' . $row; ?>"> -->
			<?php // endif; ?>
			<div class="item col-12 col-md-6 col-lg-<?=round(12 / $this->columns); ?>">
				<div class="card column-<?=$rowcount; ?><?=$item->state == 0 ? ' system-unpublished' : null; ?>"
					itemscope itemtype="https://schema.org/HotelRoom">
					<?php
					$this->item = &$item;
					echo $this->loadTemplate('item');
